...
- **20 марта 23:59 -- дедлайн сдачи кода и описания проекта** 
- ссылки: 

[221](https://classroom.github.com/a/SvfdGuoK)  Обязательно укажите **свое имя в readme репозитория**. Заранее спасибо!

[222](https://classroom.github.com/a/YJdzEBMW)  Обязательно укажите **свое имя в readme репозитория**. Заранее спасибо!

[223](https://classroom.github.com/a/1SkScaiY)  Обязательно укажите **свое имя в readme репозитория**. Заранее спасибо!

№|Шаблон|Описание|Что выбрать самостоятельно
-|------|--------------------------|----
1.|«Гарри Поттер и...»|Веб-сервис/телеграм-бот, который присылает пользователю фразы, сгенерированные с помощью модели.|Выбор моделей. Данные, на которых будет обучаться модель, сходные по объему со всеми книгами о Гарри Поттере
